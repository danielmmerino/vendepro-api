...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permisos = [
            ...
            ['codigo' => 'pedidos.items.crear',        'nombre' => 'Agregar items a pedido'],
            ['codigo' => 'pedidos.items.editar',       'nombre' => 'Editar items de pedido'],
            ['codigo' => 'pedidos.items.eliminar',     'nombre' => 'Eliminar items de pedido'],
            ['codigo' => 'pedidos.hold',               'nombre' => 'Hold pedido o curso'],
            ['codigo' => 'pedidos.fire',               'nombre' => 'Fire pedido o curso'],
            ['codigo' => 'pedidos.prioridad',          'nombre' => 'Cambiar prioridad de pedido'],
            ['codigo' => 'pedidos.enviar_cocina',      'nombre' => 'Enviar pedido a cocina'],
            ['codigo' => 'kds.comandas.ver',           'nombre' => 'Ver comandas'],
            ['codigo' => 'kds.start',                  'nombre' => 'Start comanda'],
            ['codigo' => 'kds.ready',                  'nombre' => 'Ready comanda'],
            ['codigo' => 'kds.bump',                   'nombre' => 'Bump comanda'],
            ['codigo' => 'kds.recall',                 'nombre' => 'Recall comanda'],
            ['codigo' => 'kds.reassign',               'nombre' => 'Reasignar comanda'],
            ['codigo' => 'kds.nota',                   'nombre' => 'Agregar nota comanda'],
            ['codigo' => 'kds.estaciones.ver',         'nombre' => 'Ver estaciones KDS'],
            ['codigo' => 'kds.estaciones.crear',       'nombre' => 'Crear estaciones KDS'],
            ['codigo' => 'kds.estaciones.editar',      'nombre' => 'Editar estaciones KDS'],
            ['codigo' => 'kds.estaciones.eliminar',    'nombre' => 'Eliminar estaciones KDS'],
            ['codigo' => 'kds.sla.ver',                'nombre' => 'Ver SLA KDS'],
            ['codigo' => 'kds.sla.editar',             'nombre' => 'Editar SLA KDS'],
            ['codigo' => 'kds.stream.ver',             'nombre' => 'Ver stream KDS'],
            // Caja / Ventas
